...
% ------------------ Simulaciones ------------------
  ...
  \begin{frame}{Estudio 1}
    \begin{itemize}
      \item $ \phi \sim 0.25 $ es el valor óptimo para obtener la mayor cantidad de contactos.$ \phi \sim 0.35 $ para $ L = 8.0 $. 
      \vspace{0.3cm}
      \item El Scanning Rate está en su mayor punto para densidades intermedias movido hacia bajas.
      \vspace{0.3cm}
      \item Una mayor velocidad deseada no afecta significativamente el Scanning Rate.
      \vspace{0.3cm}
      \item Un mayor tamaño del sistema manteniendo r en el mismo intervalo, desplaza el pico hacia una mayor densidad.
    \end{itemize}
  \end{frame}
  \begin{frame}{Estudio 2}
    \begin{itemize}
      \item Algunos casos presentan un ajuste al modelo de Ley de Potencias y otros a una distribución Exponencial.
      \vspace{0.3cm}
      \item No se puede establecer una distribución universal para los tiempos de contacto, varía acorde al área cubierta.
      \vspace{0.3cm}
