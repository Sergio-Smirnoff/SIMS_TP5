...
% ------------------ Introducción ------------------
  ...
  \begin{frame}{Modelo Matemático}
    \begin{itemize}
      ...
      \vspace{0.2cm}
      \\donde \(v^0\) es la velocidad deseada
    \end{itemize}
  \end{frame}
...
% ------------------ Simulaciones ------------------
  ...
  \begin{frame}{Definición de Observables}
    \begin{itemize}
      ...
      \vspace{0.3cm}
      \item \(Q=\frac{dN(t)}{dt}\), donde \(N(t)=cant. contactos\ únicos\)
      \vspace{0.3cm}
      \item \(\bm{\tau}_i=t_{i+1}-t_i\)
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}{Estudio: Contactos Únicos con Agente Fijo}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagen/accumulated_contacts.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Estudio: Exponente de la Ley de Potencias}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagen/alpha_vs_phi_clauset.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
