...
% ------------------ Simulaciones ------------------
  ...
  \subsubsection{Intervalo de Tiempo entre Contactos}
  ...
  \begin{frame}{Aproximación Power Law}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenv25/distribution_N149.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Aproximación Exponencial}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenv25/distribution_N99.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Aproximación Logarítmica}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenv25/distribution_N89.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Exponente de la Ley de Potencias}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenv25/alpha_vs_phi.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Exponente de Exponencial}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenv25/lambda_vs_phi.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Aproximación Power Law}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenl8/distribution_N59.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Aproximación Exponencial}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenl8/distribution_N259.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Aproximación Logarítmica}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenl8/distribution_N69.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Exponente de la Ley de Potencias}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenl8/alpha_vs_phi.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
  ...
  \begin{frame}{Exponente de Exponencial}
    \begin{figure}
      \centering
      \includegraphics[width=1\linewidth]{imagenl8/lambda_vs_phi.png}
      \label{fig:placeholder}
    \end{figure}
  \end{frame}
